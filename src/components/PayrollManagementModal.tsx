              ...
              <View style={styles.printContent}>
                ...
                {slipDataToPrint && (
                  <View style={styles.receiptPaper}>
                    <ThemedText style={styles.receiptTitle}>{slipDataToPrint.businessName?.toUpperCase() || 'KOKO MOTOWASH'}</ThemedText>
                    ...
                    <ThemedText style={styles.receiptStatusLine}>STATUS GAJI   : {slipDataToPrint.status?.toUpperCase() || 'LUNAS'}</ThemedText>
                    <ThemedText style={styles.receiptDivider}>--------------------------------</ThemedText>
